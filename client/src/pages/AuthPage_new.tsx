...
export const AuthPage: React.FC<AuthPageProps> = ({ onAuthSuccess }) => {
  ...
  if (currentScreen === 'auth') {
    return (
      <div 
        className="min-h-screen w-full flex items-end justify-center px-4 pb-16 relative"
        style={{
      ...
      >
        ...
        {/* Form container - posizionato in basso al centro */}
        <div className="relative z-10 max-w-md w-full bg-green-900/90 backdrop-blur-md rounded-2xl shadow-2xl p-6 md:p-8 border border-green-600/50">
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-transparent bg-gradient-to-r from-green-300 to-emerald-200 bg-clip-text mb-3 animate-pulse">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="username" className="block text-sm font-semibold text-green-200 mb-3">
                Username
              </label>
              <input
                type="text"
                ...
                required
                className="w-full px-4 py-4 bg-green-800/60 border border-green-500/40 rounded-xl text-white placeholder-green-300 focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 transition-all duration-200"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold py-4 px-6 rounded-xl hover:from-green-700 hover:to-emerald-700 transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg border border-green-500/30"
            >
              {isLoading ? (
          ...
          <div className="mt-8 text-center">
            <button
              ...
              className="text-green-300 hover:text-white transition-all duration-200 underline decoration-green-500/50 hover:decoration-white"
            >
