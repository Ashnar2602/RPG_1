-- =====================================================
-- ARCIPELAGO CENTRALE - IMPLEMENTAZIONE CORRETTA
-- Con ID delle città corretti dal database
-- =====================================================
...
('special_sala_contratti_sacri', 'Sala dei Contratti Sacri', 'Sala dove vengono firmati i più importanti accordi commerciali del mondo. I contratti qui firmati sono vincolanti magicamente e riconosciuti da tutte le nazioni.', 400.0, 200.0, 25.0, 'location', 'city_portoluna_capital', 100, 12, true, true, ARRAY['accordi_internazionali', 'contratti_magici', 'diritto_commerciale'], '{"level_min": 10, "reputation": {"merchants": 50}, "wealth_min": 5000}', CURRENT_TIMESTAMP),
...
('special_cripta_mercanti_leggendari', 'Cripta dei Mercanti Leggendari', 'Tomba che onora i più grandi mercanti della storia. I visitatori possono ricevere benedizioni commerciali e apprendere antichi segreti del commercio.', 410.0, 215.0, -5.0, 'location', 'city_portoluna_capital', 20, 10, true, true, ARRAY['tomba_mercanti', 'benedizioni_commerciali', 'saggezza_antica'], '{"level_min": 12, "reputation": {"merchants": 60}, "pilgrimage": true}', CURRENT_TIMESTAMP);
...
-- Insediamenti Minori (Tier 3)
INSERT INTO locations (id, name, description, coordinates_x, coordinates_y, coordinates_z, tier, parent_id, population, max_players, is_accessible, is_safe_zone, special_features, requirements, updated_at) VALUES
('settlement_seahawk', 'Seahawk', 'Centro di addestramento per esploratori aerei e addestratori di uccelli marini. I falchi marini addestrati qui sono i migliori messaggeri e scout del mondo.', 320.0, 150.0, 35.0, 'location', 'city_velacorta_capital', 7800, 40, true, true, ARRAY['ricognizione_aerea', 'addestramento_uccelli', 'scout_aereo'], '{"level_min": 3, "skills": {"animal_handling": 25}}', CURRENT_TIMESTAMP),
...
('settlement_pearl', 'Pearl', 'Villaggio di pescatori di perle e cercatori di tesori sottomarini. I tuffatori più esperti del mondo recuperano tesori dalle profondità marine.', 325.0, 155.0, -5.0, 'location', 'city_velacorta_capital', 4100, 22, true, true, ARRAY['pesca_perle', 'tesori_sottomarini', 'immersioni_profonde'], '{"level_min": 8, "skills": {"diving": 30}, "abilities": ["breath_hold"]}', CURRENT_TIMESTAMP);
...
('special_tempio_correnti', 'Tempio delle Correnti', 'Tempio sottomarino dedicato alle correnti marine e alla navigazione perfetta. I sacerdoti del mare benedicono i navigatori con protezione e lettura delle correnti.', 310.0, 145.0, -15.0, 'location', 'city_velacorta_capital', 30, 10, true, true, ARRAY['tempio_sottomarino', 'benedizioni_navigazione', 'lettura_correnti'], '{"level_min": 10, "skills": {"navigation": 35}, "abilities": ["water_breathing"], "faith": ["sea_gods"]}', CURRENT_TIMESTAMP),
...
('special_archivio_rotte_segrete', 'Archivio delle Rotte Segrete', 'Archivio segreto contenente le rotte marine nascoste e intelligence marittima. Solo ufficiali di alto grado e spie navali possono accedere a questi segreti.', 315.0, 155.0, -10.0, 'location', 'city_velacorta_capital', 10, 5, true, true, ARRAY['rotte_segrete', 'intelligence_marittima', 'informazioni_strategiche'], '{"level_min": 18, "rank": ["admiral", "naval_spy"], "security_clearance": "top_secret"}', CURRENT_TIMESTAMP);
...
('settlement_rum', 'Rum', 'Distilleria e centro sociale pirata. Il rum più forte e gli spiriti più potenti vengono prodotti qui per mantenere alto il morale dei pirati dell''arcipelago.', 225.0, 95.0, 10.0, 'location', 'city_mareamorta_capital', 4000, 22, true, true, ARRAY['produzione_alcool', 'morale_pirata', 'centro_sociale'], '{"level_min": 1, "skills": {"brewing": 15}, "social_standing": ["pirate"]}', CURRENT_TIMESTAMP),
...
('settlement_dance', 'Dance', 'Accademia di danza e arti del movimento. I ballerini più aggraziati e i coreografi più innovativi insegnano qui l''arte di esprimere emozioni attraverso il movimento.', 485.0, 255.0, 12.0, 'location', 'city_bellearte_capital', 4300, 25, true, true, ARRAY['danza_performativa', 'coreografia', 'arti_movimento'], '{"level_min": 2, "skills": {"dancing": 25}, "grace": 30}', CURRENT_TIMESTAMP),
...
('special_biblioteca_storie_non_scritte', 'Biblioteca delle Storie Non Scritte', 'Biblioteca contenente storie che esistono solo nell''immaginazione. I maestri narratori possono accedere a racconti mai scritti ma eternamente esistenti nel regno delle idee.', 490.0, 260.0, 22.0, 'location', 'city_bellearte_capital', 30, 8, true, true, ARRAY['storie_immaginarie', 'racconti_eterni', 'potenziale_creativo'], '{"level_min": 18, "skills": {"storytelling": 45}, "class": ["master_storyteller"], "imagination_magic": true}', CURRENT_TIMESTAMP),
...
('special_cripta_grandi_maestri', 'Cripta dei Grandi Maestri', 'Tomba che onora i più grandi artisti della storia. I pellegrini artistici vengono qui per ricevere ispirazione dai maestri del passato e apprendere tecniche perdute.', 480.0, 250.0, -8.0, 'location', 'city_bellearte_capital', 20, 12, true, true, ARRAY['maestri_storici', 'tecniche_perdute', 'saggezza_artistica'], '{"level_min": 15, "skills": {"art_history": 40}, "artistic_pilgrimage": true}', CURRENT_TIMESTAMP);
